...
import acciones
import interfaz.insertar_base as insertar_base
...
class Interfaz(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.txt_insertar = tk.Button(self,text="Insertar",width=50,command=insertar_base.Insertar_base)
        ...
        self.quit = tk.Button(self, text="QUIT",width=50, fg="red",
